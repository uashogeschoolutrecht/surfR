---
title: "Workshop 'R for Reproducible Research'"
...
Data Analysis Using R - SURF RESEARCH BOOTCAMP November 2, 2018 </div>
...
Workshop during the 2nd November 2018 SURF Research Bootcamp at Utrecht Science Park, 
The Netherlands.

## References
The code, contents and examples in this workshop were adapted from: 

 - **Git/github.com**: https://github.com/jennybc/happy-git-with-r
 - **R Markdown**: https://bookdown.org/yihui/rmarkdown/
 - **Writing functions**: "R for Data Science" http://r4ds.had.co.nz/
 - **R-packages:** https://github.com/kleinschmidt/r-packages/blob/master/tutorial.Rmd; http://r-pkgs.had.co.nz/
 - **Many models**  "R for Data Science" http://r4ds.had.co.nz/; https://www.rstudio.com/resources/videos/how-to-work-with-list-columns/
 
## Contents

 - `Git/Github.com for collaboration`
 - `{rmarkdown}` for output
 - Writing functions
 - `{devtools}` for writing R packages
 - List columns with`{purrr}` and `{broom}` for modelling
 

## Materials
This tutorial is part of an R-package at [www.github.com/uashogeschoolutrecht/surfR] and was used during the 




# Writing R-packages with RStudio and `{devtools}`

## Why building an R-package

 - The R-package structure forces you to be consistent
 - An R-package makes you write functions
 - Good R-packages have good documentation
 - R-packages can be easily shared
 - Other can contribute to your R-package 

## Prerequisites
 - You can do this in the basic GUI of R
 - But it is way more convenient to do it in RStudio



## Getting started

`devtools` makes it surprisingly easy to make a data package. 
...
## Sharing you package on Github
The [Github repository](https://github.com/kleinschmidt/r-packages) includes package source, and an example of how I've refactored an analysis from an R-Markdown file and a datafile which are also included in the package.

To get to the R-Markdown files?
`browseVignettes('surfR')`


[RMarkdown + CSV](https://github.com/kleinschmidt/r-packages/tree/f398971fab0388d5d35a392c7c9b46e74c307eb3/example) and ending up with an [RMarkdown + a package](https://github.com/kleinschmidt/r-packages/tree/c5e57de0b7ddc7968c8819fa904d00249934c055/example). 
