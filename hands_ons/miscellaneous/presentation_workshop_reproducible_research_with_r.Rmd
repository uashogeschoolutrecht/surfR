...
# "Reproducible research with R" workshop during the 2nd November 2018 SURF Research Bootcamp at Utrecht Science Park, The Netherlands.

## Code reference
The code, conmtents and examples in this workshop 

`R-package:`
 from https://github.com/kleinschmidt/r-packages/blob/master/tutorial.Rmd
