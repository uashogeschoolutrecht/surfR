...
```{r, eval=FALSE}
sum(vector %>% as.numeric(), na.rm = TRUE) ## Warning sum on character
```
...
## this code is pretty unreadable, we will see a better way later in the workshop
