...
## Example data: Enzazaden, `Wateruptake.xlsx` in folder "./data"
...
2B) Inspect the data, do need to clean the data?
```{r}
## many NAs
sum(is.na(enza_long))
...
tomato <- enza_nested$data[[1]][, "wateruptake"] %>% na.omit
onion <- enza_nested$data[[2]][, "wateruptake"] %>% na.omit
leek <- enza_nested$data[[3]][, "wateruptake"] %>% na.omit

leveneTest(tomato$wateruptake, onion$wateruptake, leek$wateruptake)
